...
void gpio_output_init(GPIO_TypeDef *port, GPIO_Pin pin, GPIO_Pull pull);
...
bool gpio_toggle_on(GPIO_TypeDef *port, GPIO_Pin pin);
bool gpio_toggle_off(GPIO_TypeDef *port, GPIO_Pin pin);
