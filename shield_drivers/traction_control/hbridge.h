...
#define HBRIDGE1_EN_PIN					GPIO_PIN_11
#define HBRIDGE1_EN_PORT				GPIOD
#define HBRIDGE1_EN_CLK_ENABLE()		__HAL_RCC_GPIOD_CLK_ENABLE()

#define HBRIDGE1_DIR_PIN				GPIO_PIN_10
#define HBRIDGE1_DIR_PORT				GPIOD
#define HBRIDGE1_DIR_CLK_ENABLE()		__HAL_RCC_GPIOD_CLK_ENABLE()
...
#define HBRIDGE2_EN_PIN					GPIO_PIN_14
#define HBRIDGE2_EN_PORT				GPIOD
#define HBRIDGE2_EN_CLK_ENABLE()		__HAL_RCC_GPIOD_CLK_ENABLE()

#define HBRIDGE2_DIR_PIN				GPIO_PIN_15
#define HBRIDGE2_DIR_PORT				GPIOD
#define HBRIDGE2_DIR_CLK_ENABLE()		__HAL_RCC_GPIOD_CLK_ENABLE()
